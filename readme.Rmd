...
This package accompanies the paper `Score-based calibration testing for multivariate forecast distributions' by Malte Knüppel, Fabian Krüger and Marc-Oliver Pohle: 
